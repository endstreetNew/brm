...
public static class SerilogOptions
{
    public static void ConfigureLogger(HostBuilderContext hostingContext, LoggerConfiguration loggerConfiguration)
    {
        ...
        var applicationName = hostingContext.Configuration.GetValue<string>("Serilog:LogApplication");
        loggerConfiguration.Enrich.WithProperty("LogApplication", applicationName);
