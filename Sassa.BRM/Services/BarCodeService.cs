...
namespace Sassa.BRM.Services
{
    public class BarCodeService
    {
        ...
        public string GetQrCode(string BRMBarCode, string CLMno, string pensionNo, string fullname, string grantname)
        {
            string code = BRMBarCode + "\t" + CLMno + "\t" + pensionNo + "\t" + fullname + "\t" + grantname;
            var qrcode = QrEncoder.Encode(code, ErrorCorrectionLevel.Q, Encoding.Unicode);
            //var qrcode = Barcoder.Qr.QrEncoder.Encode(code, Barcoder.Qr.ErrorCorrectionLevel.H, Barcoder.Qr.Encoding.Unicode);
            var renderer = new SvgRenderer();
            using var stream = new MemoryStream();
            using var reader = new StreamReader(stream);
        ...
        public string GetQrSvg(string BRMBarCode, string CLMno, string pensionNo, string fullname, string grantname)
        {
